...
class WasteProblemReportScreen extends StatefulWidget {
  static const String screenRoute = '/waste-problem-report';
  final String serviceName;
  final Color serviceColor;
  final List<Color> serviceGradient;
  final String serviceTitle;

  const WasteProblemReportScreen({
    super.key,
  ...
  @override
  State<WasteProblemReportScreen> createState() => _WasteProblemReportScreenState();
}

class _WasteProblemReportScreenState extends State<WasteProblemReportScreen> {
  ...
  Widget _buildProblemReportContent() {
    // تحديد الأيقونة واللون لخدمة النفايات فقط
    IconData serviceIcon = Icons.delete_outline;
  ...
  void _showEmergencyReport() {
    ...
    // أنواع الطوارئ لخدمة النفايات فقط
    List<String> emergencyTypes = [
      'نفايات خطرة أو طبية متسربة',
      'حاوية نفايات تحترق',
      'تراكم نفايات يسبب خطر صحية',
      'نفايات تسد الطريق الرئيسي',
      'حيوانات ضالة تتغذى على النفايات',
      'أخرى (أدخل في الوصف)'
    ];

    // تعليمات خاصة بالنفايات
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildDropdownFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'يرجى اختيار نوع الطارئ النفاياتي';
                            }
                            return null;
                          },
                          icon: Icons.warning,
                        ...
                        Container(
                          ...
                          child: const Text(
                            'ملاحظة: سيتم إرسال البلاغ الطارئ إلى فريق طوارئ النظافة للمعالجة الفورية',
                            style: TextStyle(
                              color: Colors.red,
                              fontSize: 12,
                              height: 1.5,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              const Text(
                'شكراً لك على إبلاغنا بالمشكلة الطارئة. تم إرسال بلاغك إلى فريق طوارئ النظافة للمعالجة الفورية.',
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 16),
              ),
              const SizedBox(height: 16),
  ...
  void _showServiceProblemReport() {
    ...
    // أنواع المشاكل لخدمة النفايات فقط
    ...
    IconData serviceIcon = Icons.delete_outline;
    Color serviceColor = Colors.green;
