...
class WasteEmergencyScreen extends StatefulWidget {
  static const String screenRoute = '/waste-emergency';
  final String serviceName;
  final Color serviceColor;
  final List<Color> serviceGradient;
  final String serviceTitle;

  const WasteEmergencyScreen({
    super.key,
...
class _WasteEmergencyScreenState extends State<WasteEmergencyScreen> {
