      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: isDarkMode ? Colors.grey[600]! : Colors.blue[200]!),
          ),
          child: Center(
            child: Column(
...
class _QualityAuditorWaterScreenState extends State<QualityAuditorWaterScreen> {
  ...
  final List<Map<String, dynamic>> _activeAlarms = [
    {
      'type': 'تلوث المياه',
      'location': 'محطة معالجة المياه الرئيسية - المنطقة الشرقية',
      'time': '10:30:15',
      'severity': 'حرج',
      'value': 'TDS: 1200 ppm'
    },
  ...
  final List<Map<String, dynamic>> _allNotifications = [
    {
      'id': '1',
      'type': 'تلوث المياه',
      'title': 'إنذار تلوث المياه',
      'description': 'تم رصد ارتفاع في مستويات التلوث في محطة معالجة المياه الرئيسية',
      'time': 'منذ 5 دقائق',
      'read': false,
      'tab': 0,
      'priority': 'عالي',
      'area': 'المنطقة الشرقية',
      'location': 'محطة المعالجة الرئيسية',
      'value': 'TDS: 1200 ppm',
    },
    {
      'id': '2',
      'type': 'ارتفاع العكورة',
      'title': 'إنذار ارتفاع العكورة',
      'description': 'تم رصد ارتفاع في العكورة في محطة الغربية - القطاع 5',
      'time': 'منذ ساعة',
      'read': false,
      'tab': 0,
      'priority': 'متوسط',
    ...
    },
    {
      'id': '3',
      'type': 'انخفاض الكلور',
      'title': 'إنذار انخفاض الكلور',
      'description': 'تم رصد انخفاض في مستويات الكلور في محطة الجنوب - المنطقة الصناعية',
      'time': 'منذ 3 ساعات',
      'read': true,
      'tab': 0,
      'priority': 'عالي',
    ...
    },
    {
      ...
      'description': 'تم إنشاء تقرير جودة المياه الشهري لشهر يناير 2024 بنجاح',
      'time': 'منذ يوم',
      'read': true,
      'tab': 1,
      'priority': 'منخفض',
    ...
    },
    {
      ...
      'description': 'تم إنشاء تقرير الإنذارات للأسبوع الحالي - 5 إنذارات جديدة',
      'time': 'منذ يومين',
      'read': true,
      'tab': 1,
      'priority': 'متوسط',
    ...
    },
    {
      ...
      'description': 'تم استلام بلاغ جديد من حي السلام بخصوص رائحة كريهة في المياه',
      'time': 'منذ 30 دقيقة',
      'read': false,
      'tab': 2,
      'priority': 'متوسط',
      'area': 'حي السلام',
      'complaintType': 'رائحة كريهة في المياه',
    },
  ];
  ...
  // الألوان الحكومية - لون أزرق للمياه
  final Color _primaryColor = Color(0xFF1A73E8);
  final Color _secondaryColor = Color(0xFF34A853);
  final Color _accentColor = Color(0xFF4285F4);
  ...
  void _showNotifications() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => WaterNotificationsScreen()),
    );
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          child: _buildTopTabBar(isDarkMode),
        ),
      ),
            ...
            Container(
              ...
              child: Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.map, size: 50, color: isDarkMode ? Colors.grey[400] : Colors.grey),
                    SizedBox(height: 8),
                    Text(
                      'خريطة تفاعلية لحالة جودة المياه',
  ...
  Widget _buildMonitoring() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          _buildMonitoringCard('درجة الحموضة', '7.2 pH', '6.5 - 8.5 pH', Icons.water_drop, Colors.green, isDarkMode),
          _buildMonitoringCard('العكورة', '2.5 NTU', '< 5 NTU', Icons.opacity, Colors.blue, isDarkMode),
          _buildMonitoringCard('الكلور المتبقي', '0.4 mg/L', '0.2 - 0.5 mg/L', Icons.science, Colors.orange, isDarkMode),
          _buildMonitoringCard('درجة الحرارة', '22°C', '< 25°C', Icons.thermostat, Colors.purple, isDarkMode),
          _buildMonitoringCard('TDS', '350 ppm', '< 500 ppm', Icons.analytics, Colors.red, isDarkMode),
          _buildMonitoringCard('الملوحة', '450 ppm', '< 1000 ppm', Icons.waves, Colors.teal, isDarkMode),
        ],
      ),
    );
  }
...
Widget _buildQualityQuickStatItem(String title, String value, IconData icon, Color color) {
  ...
  Future<void> _sharePdfFile(Uint8List pdfBytes, String period) async {
    try {
      ...
      await Share.shareXFiles(
        ...
        subject: 'تقرير جودة المياه - $period',
        text: 'مرفق تقرير جودة المياه للفترة $period',
      );
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 16),
                          Text(
                            'وزارة المياه - نظام مراقبة الجودة',
                            style: TextStyle(
  ...
  void _showSettingsScreen(BuildContext context, bool isDarkMode) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => WaterSettingsScreen(
  ...
  void _showHelpSupportScreen(BuildContext context, bool isDarkMode) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => WaterHelpSupportScreen(
          isDarkMode: isDarkMode,
          primaryColor: _primaryColor,
          secondaryColor: _secondaryColor,
          accentColor: _accentColor,
...
// ========== شاشة الإشعارات ==========
class WaterNotificationsScreen extends StatefulWidget {
  static const String routeName = '/water-notifications';

  @override
  _WaterNotificationsScreenState createState() => _WaterNotificationsScreenState();
}

class _WaterNotificationsScreenState extends State<WaterNotificationsScreen> {
  final Color _primaryColor = Color(0xFF1A73E8);
  final Color _secondaryColor = Color(0xFF34A853);
  final Color _successColor = Color(0xFF2E7D32);
...
class WaterHelpSupportScreen extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildContactItem(Icons.location_on_rounded, 'العنوان', 'بغداد - وزارة المياه', false, context),
          SizedBox(height: 16),
  ...
  List<Widget> _buildFAQItems() {
    List<Map<String, String>> faqs = [
      {
        'question': 'كيف يمكنني التعامل مع إنذارات تلوث المياه؟',
        'answer': 'اذهب إلى قسم الإنذارات → انقر على الإنذار الحرج → اضغط على زر "معالجة" → اتبع الإجراءات المحددة في دليل التشغيل'
      },
      {
        'question': 'كيف أعرض تقرير جودة المياه الشهري؟',
        'answer': 'انتقل إلى قسم التقارير → اختر "تقرير الجودة" → حدد الفترة الزمنية المطلوبة → انقر على "عرض التقرير"'
      },
      {
        'question': 'كيف أتحقق من حالة شبكة المياه؟',
        'answer': 'اذهب إلى قسم المراقبة → استعرض مؤشرات الجودة (درجة الحموضة، العكورة، الكلور) → تحقق من الخريطة التفاعلية'
      },
      {
        'question': 'كيف أتعامل مع بلاغات المواطنين عن المياه؟',
        'answer': 'انتقل إلى قسم البلاغات → استعرض البلاغات الجديدة → انقر على البلاغ → اضغط على "تحديث الحالة" → اختر الإجراء المناسب'
      },
      {
        'question': 'كيف أقوم بعمل نسخة احتياطية لبيانات المراقبة؟',
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildInfoRow('المطور', 'وزارة المياه'),
          _buildInfoRow('رقم الترخيص', 'MOW-2024-001'),
          _buildInfoRow('آخر تحديث', '2024-03-15'),
          _buildInfoRow('البريد الإلكتروني', 'support@water.gov.iq'),
        ],
      ),
    );
  }
