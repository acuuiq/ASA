...
class _EsigninScreenState extends State<EsigninScreen>
  ...
  final Map<String, List<String>> _specializations = {
    'كهرباء': [
      ...
      'مدقق جودة كهرباء',
      'خدمات متميزة متخصصة في الكهرباء',
      'مسؤول اعداد التقارير عن الكهربائية',
    ],
    'ماء': [
      'فني صرف صحي',
      'مشرف محطات معالجة المياه',
      'مهندس جودة مياه',
      'فني شبكات مياه',
      'مشرف صيانة مضخات المياه',
      'فني تحاليل مياه',
      'مراقب جودة المياه',
    ],
    'نفايات': [
      'مدير طلبات الحاويات',
      'مسؤول استجابة للطوارى',
      ' مسؤول الابلاغ عن النفايات',
      'مسؤول نفايات النظام',
      'مسؤول فواتير النفايات',
      'عامل تنظيف النفايات',
      'متخصص قسط النفايات',
      'جدول النفايات',
    ],
