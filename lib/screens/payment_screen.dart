...
class PaymentScreen extends StatefulWidget {
  ...
  final String? additionalInfo; // إضافة البارامتر الجديد
  ...
  const PaymentScreen({
    ...
    this.additionalInfo, // جعله اختياريًا
  });
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void _calculatePointsDiscount() {
    ...
    if (_pointsDiscount > widget.amount) {
      _pointsDiscount = widget.amount;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('دفع فاتورة ${widget.serviceName}'),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // عرض المعلومات الإضافية إذا كانت موجودة
            ...
            if (_showPaymentForm) ...[
              InkWell(
                ...
                child: Row(
                  children: [
                    Icon(Icons.arrow_back, color: widget.serviceColor),
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: [
            ...
            widget.serviceGradient[1].withOpacity(0.05),
          ],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
            ...
            _buildDiscountOption(
              ...
              onChanged: (value) {
                setState(() {
                  ...
                  if (_isEarlyPayment) {
                    _discountAmount = widget.amount * 0.1;
                  } else {
                    _discountAmount = 0.0;
                  }
                  _updateFinalAmount();
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontWeight: isTotal ? FontWeight.bold : FontWeight.normal,
              color: isTotal ? widget.serviceColor : Colors.grey[800],
            ),
          ),
        ],
      ),
        ...
        return Column(
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  Icon(category['icon'], color: widget.serviceColor),
                  const SizedBox(width: 10),
                  Text(
                    category['title'],
                    style: const TextStyle(
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Icon(Icons.verified, size: 60, color: widget.serviceColor),
              const SizedBox(height: 20),
              const Text(
                'تأكيد الدفع',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _buildDetailRow('المبلغ الأصلي', '${widget.amount} د.ع'),
                    if (_isEarlyPayment)
                      _buildDetailRow(
                        'خصم الدفع المبكر',
                        '-${_discountAmount.toStringAsFixed(2)} د.ع',
